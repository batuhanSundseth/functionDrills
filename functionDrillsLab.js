...
let jsNinja = string => "I am a JavaScript ninja!"
...
function buyMaxChocolateFrogs(gold) {
  return gold / 3
}
let totalFrogs = buyMaxChocolateFrogs(150)
...
function buyMaxChocolateFrogs2(gold) {
  return Math.floor(gold / 3)
}
let totalFrogs2 = buyMaxChocolateFrogs2(150)
